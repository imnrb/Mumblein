    ...
    <React.Fragment>
      ...
      >
        <Tooltip label="Search Users to chat" hasArrow placement="bottom-end">
          <Button variant="ghost" bg ='purple.300' onClick={onOpen} color="black"
            _hover={{ background: "purple.400", color:"yellow.400" }} _active={{ background: "purple.300", color:"yellow.400" }}>
        ...
        <Text fontSize="3xl" font-style="Poppins" fontWeight='500' color="purple.600" >
        Mumblein
        </Text>
        ...
        <div>
          ...
          <Menu>
            <MenuButton as={Button} bg="purple.300"  rightIcon={<ChevronDownIcon/>}  
            ...
            <MenuList bg = "#dbb3f5" borderColor="black" >
              <ProfileModal user={user}>
                <MenuItem fontWeight="500" color="black" _hover={{background: "blue.400"}}  >
                  My Profile
                </MenuItem>{" "}
              </ProfileModal>
              <MenuDivider/>
              <MenuItem fontWeight="500" color="black" onClick={logoutHandler} _hover={{background: "red.400"}}>
                Logout
              </MenuItem>
            </MenuList>
          </Menu>
